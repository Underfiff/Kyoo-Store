...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const isAllCategory = !category || category.toLowerCase() === "semua";

    const whereClause = isAllCategory ? {} : { category };
    ...
    const totalPages = isAllCategory ? 1 : Math.ceil(total / limit);
